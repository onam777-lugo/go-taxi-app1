...
st.markdown("""
    ...
    /* Estilo para el banner de tarifa integrado */
    .tarifa-container {
...
try:
    ...
    # --- LECTURA DE TARIFA ---
    try:
        # Buscamos específicamente en la hoja CONFIG
        df_tarifa = conn.read(spreadsheet=url, worksheet="CONFIG", ttl=0)
        precio_hoy = str(df_tarifa.iloc[0, 1])
    except:
